// Converted from node:test to vitest: the aliases this suite needs come from
// tests/vitest.config.js, and `node --test` cannot resolve `@/…` imports — so
// under node:test the file failed to load entirely, and under vitest it was
// reported as "No test suite found".
