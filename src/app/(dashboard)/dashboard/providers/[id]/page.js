  ...
  const renderModelsSection = () => {
    ...
    return (
      <div className="flex flex-wrap gap-3">
        ...
        {/* "Import from /models" disabled: the live Cline catalog floods the list
             with dozens of models; static registry entries are enough. Re-enable
             only if a per-model curation need appears. */}
